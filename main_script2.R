...
for(qq in the_ratio){
  ...
  for (i in 1:100) {
    ...
    result <- DT_fixed_Alg(obs_gen_para, 2)
  ...
  txt_path <- file.path(output_dir, paste0("results_DT2_TM_", qq, ".txt"))
  ...
  file_name <- file.path(output_dir, paste0("results_DT2_TM_", qq, ".rds"))
