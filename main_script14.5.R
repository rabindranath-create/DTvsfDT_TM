...
output_dir <- file.path(getwd(), "outputs/script14.5")
...
for(qq in the_ratio){
  ...
  for (i in 1:100) {
    ...
    result <- DT_fixed_Alg(obs_gen_para, 14.5)
  ...
  txt_path <- file.path(output_dir, paste0("results_DT14.5_TM_", qq, ".txt"))
  ...
  file_name <- file.path(output_dir, paste0("results_DT14.5_TM_", qq, ".rds"))
