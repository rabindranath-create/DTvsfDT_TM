...
output_dir <- file.path(getwd(), "outputs/script300")
...
for(qq in the_ratio){
  ...
  txt_path <- file.path(output_dir, paste0("results_DT300_TM_", qq, ".txt"))
  ...
  file_name <- file.path(output_dir, paste0("results_DT300_TM_", qq, ".rds"))
