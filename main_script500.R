...
output_dir <- file.path(getwd(), "outputs/script500")
...
for(qq in the_ratio){
  ...
  txt_path <- file.path(output_dir, paste0("results_DT500_TM_", qq, ".txt"))
  ...
  file_name <- file.path(output_dir, paste0("results_DT500_TM_", qq, ".rds"))
